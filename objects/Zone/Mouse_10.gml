if (global.state == STATES.FISH_PICK_ZONE or global.state == STATES.ANGLERFISH_PICK_ZONE or global.state == STATES.DATA_PICK_ZONE or global.state == STATES.MARK_PICK_ZONE) {
