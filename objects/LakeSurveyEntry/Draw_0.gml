...
if ((isStatePickingFish() and isFishSelectable(fishId)) or fishId == global.fishSelected) {
	...
	draw_rectangle_color(x + 50, y+33, x + sprite_get_width(sprite_index)-50, y + sprite_get_height(sprite_index)+33, c_green, c_green, c_green, c_green, false);
	draw_set_alpha(1);
}
draw_set_valign(fa_top)
draw_text_transformed(750, y + sprite_get_height(sprite_index)/2-20, label, 3, 3, 0);
